...
// BRD/CR/Codesk No/Win :                                                                                                       
// Date Of Creation     : 18.12.2019
// Description          : 3.1 Added a Parameter MWP in ContractModPushService method
//                        3.2 ADDED TRUSTEE DETAILS 
//                        3.3 IF MWP APPLICATION THEN PASS TRUSTEE DETAILS AS 100 
//********************************************************************* 
//**********************************************************************
// Sr. No.              : 4
// Company              : Life            
...
namespace UWSaralServices
{
    public class ContractModification
    {
        ...
        public void ContractModPushService(string strPQuoteNo, DataSet _dsContract, ChangeValue objChangeObj, ref int strLAPushErrorcode, ref string strLAPushStatus, string MWP) /*ID:3.1 Added MWP Flag by Dinesh Kondabattini*/
        {
            ...
            try
            {
                ...
                for (i = 0; i < _dsContract.Tables["CONTOBJ"].Rows.Count; i++)
                {
                    ...
                    {
                        NomineeRow = _dsContract.Tables["CLNTDTLS"].Select("relationshipToLifeAssured='Trustee' or relationshipToLifeAssured='Nominee' or relationshipToLifeAssured='Appointee'");/*ID:3.2 Added Trustee condition by Dinesh Kondabattini*/
                    ...
                    else
                    {
                        ...
                        /*ID:3.3 START by Dinesh Kondabattini*/
                        if (MWP == "Yes")
                        {
                        ...
                        {
                            /*ID:3.3 End by Dinesh Kondabattini*/
                            foreach (DataRow row in NomineeRow.OrderByDescending(row => row[7]))
                            {
                                string _code;
                                if (row[7].ToString() == "Appointee" || row[7].ToString() == "AP")
                    ...
                    //}
                    if (strPayerClientId != strProposerid && strIsProposer == "2")
                    {

...
namespace TPASTATUSCODE.DataLayer
{
    public class data
    {
        ...
        public int Insertrecord_woParam(string spName)
        {
            int result;
            string cnStr = ConfigurationSettings.AppSettings["transactiondbLF"];
            result = SqlHelper.ExecuteNonQuery(cnStr, CommandType.StoredProcedure, spName);
            return result;
        }

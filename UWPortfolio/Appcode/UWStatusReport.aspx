<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UWStatusReport.aspx.cs" Inherits="Appcode_UWStatusReport" %>
            ...
            <div id="divLoadingDetails" runat="server" class="col-md-12">
                ...
                <div id="LoadingDtls_container" class="box box-warning box-solid">
                    <div class="box-header with-border">
                        <div class="col-md-12">
                            <div class="col-md-9">
                                <h3 class="box-title ">UW Status Report</h3>
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            <div class="col-md-12>">
                                <asp:Label runat="server" ID="lblUWStatus" CssClass="label-danger" Text=""></asp:Label>
                            </div>
                        </div>
                        <div class="row"></div>
                        <div class="col-md-12">
                            <div class="col-md-3">
                               Status :                                                                            
                               <br /><asp:DropDownList ID="ddlStatus"  runat="server" Height="30px" Width="200px">
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                        <asp:ListItem Value="IF">Issued</asp:ListItem>
                                        <asp:ListItem Value="DC">Declined</asp:ListItem>
                               </asp:DropDownList>
                            </div>
                            <div class="col-md-2">
                                From Date :                                                                            
                                <asp:TextBox runat="server" ID="txtFromDate" Width="70%" CssClass="form-control DatePicker"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                To Date :
                                <asp:TextBox runat="server" ID="txtToDate" Width="70%" CssClass="form-control DatePicker"></asp:TextBox>
                            </div>
                            <%--<div class="col-md-4">
                                User Name :
...
<%--                                <asp:DataGrid runat="server" ID="dgUWProductivity" CssClass="table " AutoGenerateColumns="false" HeaderStyle-CssClass="btn-primary ">
                                ...
                                <asp:DataGrid ID="dgUWStatus" CssClass="table " AutoGenerateColumns="True" HeaderStyle-CssClass="btn-primary" runat="server"> 
                                    <Columns>

...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style type="text/css">
        ...
        */
        ...
        /*6.1 Begin of Changes; Bhaumik Patel - [CR-4134]*/
        .blank {
            display: none;
        }
        /*6.1 End of Changes; Bhaumik Patel - [CR-4134]*/
        ...
        /*7.1 Begin of changes  Added By Royson Pinto on 22nd NOV to style Radio Buttons*/
        input[type="radio"] {
            margin: 0px 5px 0px 5px !important;
        }
        /*7.1 End of changes  Added By Royson Pinto on 22nd NOV to style Radio Buttons*/
        .IIBScore_Div {
            width: 10px;
            margin-top: 10px;
            padding-left: 5.5px;
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            prm.add_endRequest(function () {
                ...
                <%--// 8.1 Begin of Changes; Jayendra  - [Webashlar01]--%>
                ...
                <%--// 8.1 End of Changes; Jayendra  - [Webashlar01]--%>
                //Journal Details
        ...
        //5.1 Begin of changes CR-30543 by sushant Devkate [MFL00905]
...
//5.1 End of changes CR-30543 by sushant Devkate [MFL00905]
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <asp:GridView runat="server" ID="GridMsarTsar" CssClass="table table-bordered table-striped" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Total Premium" DataField="TOTALPREMIUM" />
                                       <%--10.1 Begin of Changes; Bhaumik Patel - [CR-5523]--%>
                                    <asp:BoundField HeaderText="Death Benefit" DataField="DEATHBENEFIT" />
                                    <%--10.1 End of Changes; Bhaumik Patel - [CR-5523]--%>
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel20" runat="server">
            <ContentTemplate>
                <div id="xyz" class="box box-warning box-solid">
                   ...
                   <%--  Start 3.1: This CR-2809 changes done by Sushant Devkate MFL00905 --%>
                     ...
                     <%--  End 3.1: This CR-2809 changes done by Sushant Devkate MFL00905 --%>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Description" HeaderStyle-CssClass="ReqDescp">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TextBox ID="lblfollowupDiscp" CssClass="form-control" onkeypress="Restrict()" Width="300px"
                                                ...
                                                <asp:TemplateField HeaderText="Category">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:DropDownList CssClass="form-control" ID="ddlCategory" runat="server" Width="100px" ClientIDMode="Static">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                         ...
                                         <div class="col-md-2">
                                          <div class="form-group">
                                              <label></label>
                                                ...
                                                <asp:Button runat="server" ID="btncalculatePrem_Load" OnClick="btncalculatePrem_Prod_Click" Text="Calculate Premium" CssClass="form-control btn-primary HideControl lnkButton" />
                                              <%--end--%>
                                             </div>
                                        </div>
                                         <%--12.1 End of Changes; Bhaumik Patel - [CR-3334]--%>
                                    ...
                                    <asp:GridView ID="gvExtLoadDetails" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" runat="server" OnRowDataBound="gvExtLoadDetails_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Application No">
                                                ...
                                                <ItemTemplate>
                                                    <%--<asp:DropDownList ID="ddlexistingAppno" CssClass="form-control lblLable" runat="server" Enabled="false"></asp:DropDownList>--%>
                                                    <asp:Label ID="lblexistAppno" CssClass="form-control lblLable" runat="server" Text='<%# Bind("LD_applicationNoStr") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <%--end--%>
                                            <asp:TemplateField HeaderText="LoadingType">
                   ...
                   <div class="box-body">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Is Smoker</label><br />
                                <div class="form-group">
                                     <!-- added OnChange="fnChangeSmokar(this)" 5.1 Start of Changes; Sushant Devkate - [MFL00905]-->
                        ...
                        <!--8.1 Start of Changes; Sagar Thorave - [MFL00886]-->
                         ...
                         <!--8.1 End of Changes; Sagar Thorave - [MFL00886]-->
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Risk Score</label><br />
                         ...
                         <!--4.1 Begin of Changes; Sagar Thorave - [MFL00886]-->
                         <div class="col-md-2 form-group">
                              <label>Aml Risk Score</label>
                                <br/>
                            <asp:DropDownList ID="DrpAml" AutoPostBack="true" CssClass="form-control"  disabled="true" runat="server" onchange="fnLoaderShow();" OnSelectedIndexChanged="DrpAml_SelectedIndexChanged"  >
                                <asp:ListItem Value="1">Low Risk</asp:ListItem>
                                <asp:ListItem Value="4">High Risk</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                         <!--4.1 End of Changes; Sagar Thorave - [MFL00886]-->
                        <div class="col-md-2">
                            <div class="form-group">
    ...
    <div id="divCommentDetails" runat="server" class="col-md-12">
         <!-- added UpdateMode="Conditional"  5.1 Start of Changes; Sushant Devkate - [MFL00905]-->
   ...
   <%--ADDED BY SURAJ FOR AU case Bank Relationship ON 28 SEP 19--%>		
                ...
                <div id="DecisionDtls_container" class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                       ...
                       <%--added by suraj for combi--%>
                        <asp:Repeater ID="rptDecision" OnItemDataBound="rptDecision_ItemDataBound" runat="server">
                            <HeaderTemplate>
                                <div class="">
                            </HeaderTemplate>
                            <ItemTemplate>
                                      ...
                                      <%-- <div id="divUWReason" runat="server">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddlUWreason" CssClass="form-control select2" Style="width: 50%;" runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                               ...
                               <%--//11.1 END of Changes; Sagar Thorave - [CR-7049]--%> 
                                ...
                                <div class="col-md-12">--%>
                                        <div id="divUWReason2" runat="server" visible="false">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtUWreason2" CssClass="form-control" Style="width: 75%;" runat="server" ReadOnly="true">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <div id="divPostponedPeriod"  runat="server" visible="false">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlPeriod" class="form-control select2" Style="width: 60%;" runat="server">
                                     ...
                                     <%--7.1 Begin of changes Added By Royson Pinto on 22nd NOV to display Restrict Further Cover--%>
                                       <div runat="server">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <div class="form-group">
                               ...
                               <%--7.1 End of changes Added By Royson Pinto on 22nd NOV to display Restrict Further Cover--%>
                                   </div>
    ...
    <%--end here--%>
           <!--5.1 start of Changes; Sushant Devkate - [MFL00905]-->
    <asp:UpdatePanel ID="UpdatePanelSmokar" runat="server" UpdateMode="Conditional">
     ...
     <div id="mdISSmokar" class="modal fade modal-info" aria-labelledby="myModalLabel1" role="dialog"  aria-hidden="true" data-backdrop="static" data-keyboard="false">
         ...
         <!--5.1 End of Changes; Sushant Devkate - [MFL00905]-->
    <div class="col-md-6">

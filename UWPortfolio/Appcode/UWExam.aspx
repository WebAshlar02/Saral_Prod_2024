            ...
            <div id="dialog" class="window">
                <div id="lblQueDesign">
                    <div style="background-color: brown;">
                        <asp:Label runat="server" ID="lblQue" Text="" ForeColor="White"></asp:Label><br />
                    </div>
                    <br />

                    <asp:Label runat="server" ID="lblAnsOpt" CssClass="lblQue" Text="Ans: "></asp:Label>
                    <div style="background-color: brown">
                        <asp:RadioButtonList runat="server" ID="rbtnAnsOpt"
                            ForeColor="White"
                            OnSelectedIndexChanged="rbtnAnsOpt_SelectedIndexChanged"
                            AutoPostBack="true" RepeatDirection="Vertical" ItemType="radio">
                        </asp:RadioButtonList><br />
                    </div>

                    <div id="btnSubmitDesign" runat="server" visible="false">
                        <table align="center">
                            <tr>
                                <td>

...
public partial class Appcode_Bpmuwmodule : System.Web.UI.MasterPage
{
    ...
    static POSLog.POSLog objLog = new POSLog.POSLog();
    static SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["SqlPOSTConnectionString"].ConnectionString);
    int ConsentReqtRaisedCount;
        ...
        try
        {
            ...
            if (IsCombi)
            {
                foreach (RepeaterItem item in rptDecision.Items)
                {
                    ...
                    //3.1 Begin of changes  CR-4783 Added By Royson Pinto on 22nd NOV to store Restrict Further Cover
                    RadioButton rb = (RadioButton)item.FindControl("rbYes");
                    RadioButton rb1 = (RadioButton)item.FindControl("rbNo");
                    if (rb.Checked == true)
                    {
                        objCommonObj._Restrict_Further_Cover = rb.Text;
                    }
                    else
                    {
                        objCommonObj._Restrict_Further_Cover = "";
                    }
                    if (rb1.Checked == true)
                    {
                        objCommonObj._Restrict_Further_Cover = rb1.Text;
                    }
                    else
                    {
                        objCommonObj._Restrict_Further_Cover = "";
                    ...
                    //3.1 End of changes  CR-4783 Added By Royson Pinto on 22nd NOV to store Restrict Further Cover
                    ...
                    //5.1 Begin of Changes; Bhaumik Patel - [CR-3334]
                    ...
                    //5.1 End of Changes; Bhaumik Patel - [CR-3334]
                    ...
                    /*END HERE*/
                    //combi pending status update
                    PendingStatus(lblAppno.Text,ref intRetVal);
                    //end
    ...
    private void UpdateDecisionInLa(ref int response)
    {
        ...
        objLog.logData(con, "", "", "UpdateDecisionInLa", "", "", "AppNo", strApplicationno, "isConsentReq", "", "", "", "", "", "I", "");
        logData("", "", "", "UpdateDecisionInLa", "", "AppNo", strApplicationno, "", "", "", "", "", "", "I", "");
            ...
            if (LAPushErrorCode == 0)
            {
                        ...
                        else
                        {
                            ...
                            else if (ddlUWDecesion.SelectedValue == "proposal" && LAPushErrorCode == 0)
                            {
                                ...
                                if (isConsentReq)
                                {
                                    try
                                    {
                                        //objLog.logData(con, "CR-28153_Consent Letter Start ", "ConsentRequired" + isConsentReq, "Appcode_Bpmuwmodule", "UpdateDecisionInLa", "", "ConsentApplicationNo:", strApplicationno, "", "", string.Empty, string.Empty, string.Empty, "ConsentLetter:UW", "I", "ConsentLetter:UW");

                                        objComm.OnlineRequirmentDisplayDetails_GET(ref dsreqdetails, strApplicationno, strChannelType);
                                        objLog.logData(con, "CR-28153_Consent Letter Start ", "CountOfRequirementsRaised" + dsreqdetails.Tables.Count, "UpdateDecisionInLa", "", "", "AppNo", strApplicationno, "", "", "", "", "", "ConsentLetter:UW", "I", "");
                                        logData("", "CR-28153_Consent Letter Start", "", "UpdateDecisionInLa", "CountOfRequirementsRaised" + dsreqdetails.Tables.Count, "AppNo", strApplicationno, "", "", "", "", "", "ConsentLetter:UW", "I", "");
                                        ...
                                        if (dsreqdetails.Tables[0].Rows.Count > 0)
                                        {
                                            ...
                                            objLog.logData(con, "Consent FollowUpCode Not Raised", "ConsentRequirmentRaisedCount: " + ConsentReqtRaisedCount, "Appcode_Bpmuwmodule", "UpdateDecisionInLa", "", "ConsentApplicationNo:", strApplicationno, "ConsentRaisedStatus: " + ConsentRaised, "", string.Empty, string.Empty, string.Empty, "ConsentLetter:UW", "I", "ConsentLetter:UW");
                                            logData("", "Consent FollowUpCode Not Raised", "", "UpdateDecisionInLa", "ConsentReqtRaisedCount" + ConsentReqtRaisedCount, "AppNo", strApplicationno, "", "", "", "", "", "ConsentLetter:UW", "I", "");
                                    ...
                                    catch (Exception ex)
                                    {
                                        ...
                                        objLog.logData(con, "ConsentLetter Failure", ex.ToString(), "Appcode_Bpmuwmodule", "UpdateDecisionInLa", "", "ConsentApplicationNo:", strApplicationno, "ConsentRaisedStatus: " + ConsentRaised, "", string.Empty, string.Empty, string.Empty, "ConsentLetter:UW", "E", "ConsentLetter:UW");
                                        logData("", "", "ConsentLetterFailure" + ex.ToString(), "", "", "AppNo", strApplicationno, "", "", "", "", "", "ConsentLetter:UW", "E", "");
                                    }
                                ...
                                {
                                    objLog.logData(con, "ConsentLetter Failure", "", "Appcode_Bpmuwmodule", "UpdateDecisionInLa", "", "ConsentApplicationNo:", strApplicationno, "ConsentRaisedStatus: " + ConsentRaised, "", string.Empty, string.Empty, string.Empty, "ConsentLetter:UW", "I", "ConsentLetter:UW");
                                    Logger.Info(strApplicationno + "ConsentFollowUpNotRaised" + " " + isConsentReq + System.Environment.NewLine);
                                    logData("", "", "ConsentLetterFailure", "", "", "AppNo", strApplicationno, "", "", "", "", "", "ConsentLetter:UW", "I", "");
                ...
                else
                {
                    ...
                    else if (ddlUWDecesion.SelectedValue == "proposal" && LAPushErrorCode == 0)
                    {
                        ...
                        {
                            objComm.OnlineRequirmentDisplayDetails_GET(ref dsreqdetails, strApplicationno, strChannelType);
                            objLog.logData(con, "", "", "", "UpdateDecisionInLa", "", "AppNo", strApplicationno, "", "", "", "", "", "ConsentLetter: UW", "", "");
                            logData("", "", "", "", "", "AppNo", strApplicationno, "RequirementsCount: " + dsreqdetails.Tables.Count, "", "", "", "", "ConsentLetter:UW", "I", "");
                            ...
                            if (dsreqdetails.Tables[0].Rows.Count > 0)
                            {
                                ...
                                if (txtSumassure.Text.Trim() != hdfSumassure.Value.Trim() && txtSumassure.Text.Trim() == hfdCalPremSA.Value.Trim() && hfdCalPremFlag.Value == "0")
                                {
                                    ...
                                    objLog.logData(con, "", "", "", "UpdateDecisionInLa", "", "AppNo", strApplicationno, "Not Clicked on Premium calculation", "", "", "", "", "ConsentLetter: UW", "", "");
                                    logData("", "", "", "", "", "AppNo", strApplicationno, "RequirementsCount: " + dsreqdetails.Tables.Count, "Not Clicked on Premium calculation", "", "", "", "ConsentLetter:UW", "I", "");
    ...
    /*end here*/
    /*added by suraj on 3 JAN 22 to update status to pending*/
    private void PendingStatus(string strAppno, ref int intRet)
    {
        objComm = new Commfun();
        objComm.PendingStatus(strAppno, ref intRet);
    }
    /*end here*/
    ...
    private bool ConsentLetter(string strApplicationno, string ChannelType)
    {
        ...
        try
        {
            ...
            objLog.logData(con, "", "", "", "ConsentLetter", "", "AppNo", strApplicationno, "", "", "", "", "", "", "", "");
            logData("", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
            ...
            try
            {
                ...
                dt = _ds.Tables[0];
                objLog.logData(con, "", "Data Not Found", Convert.ToString(ConsentRaised), "ConsentLetter", "", "AppNo: " + strApplicationno, "PolicyNo: " + strPolicyNo, "", "", "", "", "", "ConsentLetter:UW", "I", "");
                logData("", "", "Data Not Found", "", "AppNo", "AppNo", strApplicationno, "", "", "", "", "ConsentLetter:UW", "I", "", "");


                if (dtclientinfo.Rows.Count > 0 && dtproductdetails.Rows.Count > 0 && dt.Rows.Count > 0)
                {
                    objLog.logData(con, "", "", "", "ConsentLetter", "", "AppNo: " + strApplicationno, "PolicyNo: " + strPolicyNo, "", "", "", "", "", "ConsentLetter:UW", "I", "");
                    logData("", "", "", "", "", "AppNo", strApplicationno, "ConsentRaised", "", "", "", "", "ConsentLetter:UW", "I", "");
                    ...
                    try
                    {
                        ...
                        objLog.logData(con, "EmailCommID" + RequestID, "Consent Raised", Convert.ToString(ConsentRaised), "ConsentLetter", "", "AppNo: " + strApplicationno, "PolicyNo: " + strPolicyNo, "", "", "", "", "", "ConsentLetter:UW", "I", "");
                        SMSRequestID = API_FetchRequestID(ConfigurationManager.AppSettings["ConsentSMS"].ToString().Trim(), objconsentparams.Guid);
                        logData("", "", "SMSRequestId" + RequestID, "Consent Raised", Convert.ToString(ConsentRaised), "AppNo", strApplicationno, "ConsentRaised", "", "", "", "", "ConsentLetter:UW", "I", "");
                    ...
                    catch (Exception ex)
                    {
                        ...
                        objLog.logData(con, "SMSCommId" + SMSRequestID + "," + "EmailCommId" + RequestID, "CounterOffer Communication Failure" + ex.ToString(), Convert.ToString(ConsentRaised), "ConsentLetter", "", "AppNo: " + strApplicationno, "PolicyNo: " + strPolicyNo, "", "", "", "", "", "ConsentLetter:UW", "I", "");
                        logData("", "SMSCommId" + SMSRequestID, "EmailID" + RequestID, "CounterOffer Communication Failure" + ex.ToString(), Convert.ToString(ConsentRaised), "AppNo", strApplicationno, "ConsentRaised", "", "", "", "", "ConsentLetter:UW", "I", "");
            ...
            catch (Exception ex)
            {
                ...
                objLog.logData(con, "SMSCommId" + SMSRequestID + "," + "EmailCommId" + RequestID, "ConsentLetter|Exception Details" + ex.Message.ToString(), Convert.ToString(ConsentRaised), "ConsentLetter", "", "AppNo: " + strApplicationno, "PolicyNo: " + strPolicyNo, "", "", "", "", "", "ConsentLetter:UW", "I", "");
                logData("", "SMSCommId" + SMSRequestID, "EmailID" + RequestID, "ConsentLetter|Exception Details" + ex.Message.ToString(), Convert.ToString(ConsentRaised), "AppNo", strApplicationno, "ConsentRaised", "", "", "", "", "ConsentLetter:UW", "I", "");
        ...
        {
            objLog.logData(con, "", "", "ConsentLetter_Failure-2" + ex.Message.ToString(), "ConsentLetter", "", "AppNo", Convert.ToString(ConsentRaised), "ConsentLetter", "", "", "PolicyNo: " + strPolicyNo, "", "ConsentLetter:UW", "I", "");
            logData("", "", "", "ConsentLetter_Failure-2" + ex.Message.ToString(), Convert.ToString(ConsentRaised), "AppNo", strApplicationno, "ConsentRaised", "", "", "", "", "ConsentLetter:UW", "I", "");
    ...
    public string logData(string ErrorUserDesc, string ErrorLogDesc, string ClassName, string MethodName, string LayerCode, string DataKey, string DataValue, string RequestBO, string ResponseBO, string XmlRequestData, string XmlResponseData, string BOErrorCode, string ApplicationSource, string LogType, string Comments)
    {



        string apiUrl = ConfigurationManager.AppSettings["AppTrackerApi"].ToString();
...

        {
...

            {
                ...
                ErrorUserDesc = ErrorUserDesc,

                ErrorLogDesc = ErrorLogDesc,
                ...
                XmlResponseData = XmlResponseData,

                BOErrorCode = BOErrorCode,

                ApplicationSource = "ConsentLetter:UW Application",
            ...
            HttpResponseMessage response = client.PostAsync(apiUrl + "/SaveLogData", inputContent).Result;
    ...
    private void UpdateDecisionInLa_Combi(ref int response, DropDownList ddlUWDecesion, DropDownList ddlUWDecesioncategory, ListBox ddlUWreason, TextBox txtUWreason2, DropDownList ddlPostpone, Label lblErrorDecisiondtls)
    {
        ...
        //call servics
        objComm.OnlineUWDecisionDetails_Save(objCommonObj._AppType, strApplicationno, ddlUWDecesion.SelectedItem.Text, strddluereasontext, ddlUWDecesion.SelectedValue, strddluereasonvalue, _strUWPeriod, struserid, objChangeObj.userLoginDetails._UserName, objChangeObj.userLoginDetails._UserGroup, objCommonObj._bpm_branchCode, objCommonObj._bpm_creationDate,
      objCommonObj._bpm_systemDate, objCommonObj._bpm_businessDate, objChangeObj.userLoginDetails._userBranch, objChangeObj.userLoginDetails._ProcessName, strApplicationno,  ref UWDecisionResult);
    ...
    //4.1 Begin of Changes; Bhaumik Patel - [CR-5307]
    ...
    //4.1 End of Changes; Bhaumik Patel - [CR-5307]
}
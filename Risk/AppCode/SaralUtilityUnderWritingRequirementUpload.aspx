<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaralUtilityUnderWritingRequirementUpload.aspx.cs" Inherits="AppCode_SaralUtilityUnderWritingRequirementUpload" %>
      ...
      <%--enter data--%>
                <div id="LoadingDtls_container" class="box box-warning box-solid">
                    <div class="box-header with-border">
                        <div class="col-md-12">
                            <div class="col-md-9">
                                <h3 class="box-title ">Under Writing Requirement Upload</h3>

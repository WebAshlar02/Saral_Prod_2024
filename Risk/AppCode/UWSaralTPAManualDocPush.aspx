<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UWSaralTPAManualDocPush.aspx.cs" Inherits="AppCode_UWSaralTPAManualDocPush" %>
    ...
    <%--enter data--%>
                <div id="LoadingDtls_container" class="box box-warning box-solid">
                    <div class="box-header with-border">
                        <div class="col-md-12">
                            <div class="col-md-9">
                                <h3 class="box-title ">TPA Excel Upload</h3>
